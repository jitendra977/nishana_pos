...
//     final provider = Provider.of<GrandTotalProvider>(context);
//     return Scaffold(
//       appBar: AppBar(
//         centerTitle: true,
...
//                   final cartQuery = cartRef
//                       .where("userId", isEqualTo: userId?.uid)
//                       .where("itemName", isEqualTo: name)
//                       .where("table_number", isEqualTo: "Table1");
//                   final cartSnapshot = await cartQuery.get();
//                   if (cartSnapshot.docs.isNotEmpty) {
//                     final cartItem = cartSnapshot.docs.first;
//                     final newQty = (cartItem.data()["qty"] ?? 0) + 1;
//                     cartItem.reference.update({"qty": newQty});
//                   } else {
...
//                         child: Center(
//                             child:
//                                 Text((item['qty'] * item['price']).toString())),
//                       ),
//                       TableCell(
...
//                     TableCell(
//                       child: Text(
//                         '${Provider.of<GrandTotalProvider>(context).grandTotal}',
//                         style: TextStyle(fontWeight: FontWeight.bold),
//                       ),
//                     ),
//                   ],
